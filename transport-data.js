/* Studio Wromo v1.0.4 MIT - trasport-data.js  Execute only with BACKEND URL request method for All type of backend to Send or GET data to web local storage  */
